            ...
            <section className="max-w-[1600px] mx-auto px-6 py-2 md:px-8 md:py-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 mb-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
                     {data.styles.map((style) => {
                        ...
                        return (
                           <div 
                              key={style} 
                              className="premium-card relative h-64 overflow-hidden rounded-xl cursor-pointer transition-all hover:ring-4 hover:ring-[#4CAF50] hover:ring-offset-4 hover:ring-offset-[#fafaf9] hover:shadow-2xl" 
               ...
               <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 lg:gap-8 mt-8">
                  {filteredProducts.map((p, idx) => (
                     ...
                     >
                        <div className="relative aspect-square rounded-xl overflow-hidden shadow-sm transition-all duration-700 hover:shadow-2xl hover:-translate-y-1">
                           <Image
                              src={p.image}
                              alt={p.name}
                              fill
